...
import { RocketIcon, Mail, Phone } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li>
                                <button onClick={() => handleLinkClick('/sobre')} className="text-slate-400 hover:text-teal-400 text-sm transition-colors">
                                    Sobre Nós
                                </button>
                            </li>
                            <li>
                                <button onClick={() => handleLinkClick('/politica-de-privacidade')} className="text-slate-400 hover:text-teal-400 text-sm transition-colors">
                                    Política de Privacidade
                                </button>
                            </li>
                            <li>
                                <button onClick={() => handleLinkClick('/termos-de-uso')} className="text-slate-400 hover:text-teal-400 text-sm transition-colors">
                                    Termos de Uso
                                </button>
                            </li>
                        </ul>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <a
                                    ...
                                    className="text-slate-400 hover:text-teal-400 text-sm transition-colors break-all"
                                >
